...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var response, showList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get('http://api.tvmaze.com/search/shows', { params: { q: term } })];
                case 1:
                    response = _a.sent();
                    showList = response.data.map(function (x) {
                        var fallBackImage = "";
